...
from torch.ao.quantization.backend_config.backend_config import BackendConfig, DTypeConfig, DTypeWithConstraints
...
def get_qnnpack_TPU_backend_config() -> BackendConfig:
    """
